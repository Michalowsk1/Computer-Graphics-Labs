...
int main( void )
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        mat4 translate = Maths::translate(vec3(0.0f, 0.0f, -2.0f));
        mat4 scale = Maths::scale(vec3(0.5f, 0.5f, 0.5f));
        mat4 rotate = Maths::rotate( angle, vec3(0.0f, 1.0f, 0.0f));
        mat4 model = translate * rotate * scale;

        //calculate view matrix
        mat4 view = lookAt(vec3(1.0f, 1.0f, 1.0f), //eye
                           vec3(0.0f, 0.0f, -2.0f), //target
                           vec3(0.0f, 1.0f, 0.0f)); //worldUp

        //calculate orthographic projection matrix
        //mat4 projection = ortho(-2.0f, 2.0f, -2.0f, 2.0f, 0.0f, 10.0f);

        //Calculate perspective projection matrix
        mat4 projection = perspective(Maths::radians(45.0f), 1024.0f / 768.0f, 0.2f, 10.0f);
